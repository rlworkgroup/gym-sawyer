...
from sawyer.garage.misc.console import colorize
...
def _get_prefix(cls):
    from sawyer.garage.policies import Policy
    from sawyer.garage.baselines import Baseline
    from sawyer.garage.algos import Algorithm
